...
const About = () => {
  // Skills updated to reflect Data Engineering, Full-Stack, DevOps, and Project Management
  const skills = [
    { name: "Data Engineering, ETL & Pipelines", level: 95 },
    { name: "Python, SQL, Java, Node.js", level: 92 },
    { name: "Cloud Platforms (AWS, Azure, GCP)", level: 90 },
    { name: "Databases (Snowflake, Teradata, RDBMS, NoSQL)", level: 88 },
    { name: "DevOps, Docker, Kubernetes, CI/CD", level: 85 },
    { name: "Full-Stack Dev (Spring, Angular, React)", level: 82 },
    { name: "Technical Project & Product Management", level: 80 },
  ];
