  ...
  const experiences = [
    {
      ...
      description: [
        "Orchestrated complex delivery station launches, achieving a \"Double 100%\" performance rating through meticulous design audits.",
        "Acted as a primary subject matter expert, providing technical guidance to peers and leadership for team alignment.",
        "Spearheaded an enterprise-wide initiative to enhance stakeholder communication for the 2026 project cycle.",
      ],
    },
    {
      company: "Cognizant",
      ...
      description: [
        ...
        "Dived deep into monitoring metrics and performance data to diagnose system failures and resolve infrastructure issues quickly. (Dive Deep)",
        "Collaborated with networking, infrastructure, and engineering teams to restore critical services during high-priority incidents and meet SLA commitments. (Earn Trust)",
        "Designed automation scripts using Python and Bash, reducing manual configuration effort by 30% and improving deployment efficiency. (Invent and Simplify)",
        "Maintained deployment documentation, operational runbooks, and technical procedures to support field engineering teams.",
      ],
    },
    {
      company: "Tern",
